...
<section class="py-0 px-0 bg-black relative">
  <!-- Subtle grid background -->
  <div class="absolute inset-0 bg-[linear-gradient(to_right,#1a1a3f_1px,transparent_1px),linear-gradient(to_bottom,#1a1a3f_1px,transparent_1px)] bg-[size:2rem_2rem] opacity-20" >
  </div>
  ...
  <div class="max-w-7xl mx-auto relative z-10">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 auto-rows-fr">
      {#each features as feature, i}
        <div 
          class="group relative p-6 bg-gray-950/80 backdrop-blur-sm border border-gray-900 
        ...
        >
          ...
          <div
            ...
            style="background: linear-gradient(to right, rgba(6, 182, 212, 0.1), rgba(167, 139, 250, 0.1));
